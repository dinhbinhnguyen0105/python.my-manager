# Form implementation generated from reading ui file '/Volumes/KINGSTON/Dev/python/pyhon.my-manager/ui/dialog_re_product_settings.ui'
#
...
class Ui_Dialog_REProductSettings(object):
    def setupUi(self, Dialog_REProductSettings):
        ...
        Dialog_REProductSettings.resize(575, 386)
...
"}")
        ...
        self.gridLayout_4.addWidget(self.furniture_s_radio, 1, 2, 1, 1)
        self.image_dir_radio = QtWidgets.QRadioButton(parent=self.groupBox)
        self.image_dir_radio.setObjectName("image_dir_radio")
        self.gridLayout_4.addWidget(self.image_dir_radio, 1, 4, 1, 1)
        self.gridLayout_5.addLayout(self.gridLayout_4, 0, 0, 1, 1)
        self.verticalLayout_4.addWidget(self.groupBox)
        self.basic_setting_container = QtWidgets.QGroupBox(parent=Dialog_REProductSettings)
        self.basic_setting_container.setTitle("")
        self.basic_setting_container.setObjectName("basic_setting_container")
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout(self.basic_setting_container)
        self.horizontalLayout_2.setContentsMargins(8, 4, 8, 4)
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.horizontalLayout = QtWidgets.QHBoxLayout()
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.name_vi_container = QtWidgets.QWidget(parent=self.basic_setting_container)
        ...
        self.name_en_container = QtWidgets.QWidget(parent=self.basic_setting_container)
        ...
        self.value_container = QtWidgets.QWidget(parent=self.basic_setting_container)
        ...
        self.verticalLayout_4.addWidget(self.basic_setting_container)
        self.image_dir_setting_container = QtWidgets.QGroupBox(parent=Dialog_REProductSettings)
        self.image_dir_setting_container.setEnabled(True)
        self.image_dir_setting_container.setTitle("")
        self.image_dir_setting_container.setFlat(False)
        self.image_dir_setting_container.setCheckable(False)
        self.image_dir_setting_container.setObjectName("image_dir_setting_container")
        self.horizontalLayout_6 = QtWidgets.QHBoxLayout(self.image_dir_setting_container)
        self.horizontalLayout_6.setContentsMargins(8, 4, 8, 4)
        self.horizontalLayout_6.setObjectName("horizontalLayout_6")
        self.horizontalLayout_7 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_7.setObjectName("horizontalLayout_7")
        self.image_dir_value_container = QtWidgets.QWidget(parent=self.image_dir_setting_container)
        self.image_dir_value_container.setStyleSheet("")
        self.image_dir_value_container.setObjectName("image_dir_value_container")
        self.gridLayout_10 = QtWidgets.QGridLayout(self.image_dir_value_container)
        ...
        self.image_dir_value_label = QtWidgets.QLabel(parent=self.image_dir_value_container)
        self.image_dir_value_label.setObjectName("image_dir_value_label")
        self.verticalLayout_10.addWidget(self.image_dir_value_label)
        self.image_dir_value_input = QtWidgets.QLineEdit(parent=self.image_dir_value_container)
        self.image_dir_value_input.setObjectName("image_dir_value_input")
        self.verticalLayout_10.addWidget(self.image_dir_value_input)
        self.gridLayout_10.addLayout(self.verticalLayout_10, 0, 0, 1, 1)
        self.horizontalLayout_7.addWidget(self.image_dir_value_container)
        self.img_dir_is_selected_checkbox = QtWidgets.QCheckBox(parent=self.image_dir_setting_container)
        self.img_dir_is_selected_checkbox.setObjectName("img_dir_is_selected_checkbox")
        self.horizontalLayout_7.addWidget(self.img_dir_is_selected_checkbox)
        self.horizontalLayout_6.addLayout(self.horizontalLayout_7)
        self.verticalLayout_4.addWidget(self.image_dir_setting_container)
        self.create_btn = QtWidgets.QPushButton(parent=Dialog_REProductSettings)
    ...
    def retranslateUi(self, Dialog_REProductSettings):
        ...
        self.image_dir_radio.setText(_translate("Dialog_REProductSettings", "Image dir"))
        ...
        self.image_dir_value_label.setText(_translate("Dialog_REProductSettings", "value"))
        self.img_dir_is_selected_checkbox.setText(_translate("Dialog_REProductSettings", "Is selected"))
